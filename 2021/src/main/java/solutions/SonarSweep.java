...
/**
 * Day 1 As the submarine drops below the surface of the ocean, it automatically
 ...
 * 
 * 199 200 208 210 200 207 240 269 260 263 This report indicates that, scanning
 * outward from the submarine, the sonar sweep found depths of 199, 200, 208,
 * 210, and so on.
 * 
 ...
 * (increased) 200 (decreased) 207 (increased) 240 (increased) 269 (increased)
 * 260 (decreased) 263 (increased) In this example, there are 7 measurements
...
public class SonarSweep {
    ...
    public static void main(String args[]) {
        ...
        SonarAnalyzer analyzer = new DecreasingDepthAnalyzer(new Sonar(seabed), 1);
