...
public class NutritionalInfoReader {
    ...
    public Map<Integer, List<Integer>> byElf(List<String> infos) {
        ...
        // For now, elfs are identified by their position in line, i.e. a number
        // starting at 1
        ...
        infos.stream().forEach(i -> {
            if (i.isBlank()) {
                ...
                List<Integer> caloriesForElf = caloriesByElf.getOrDefault(elfCounter.getValue(),
