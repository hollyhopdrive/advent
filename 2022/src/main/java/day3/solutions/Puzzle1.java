 ...
 * uppercase P. The fourth rucksack's compartments only share item type v. The
 * fifth rucksack's compartments only share item type t. The sixth rucksack's
...
public class Puzzle1 {
    ...
    public static void main(String[] args) {
        ...
        int answer = Runner.run(args[0], new ReorgPrioritizationAction());
